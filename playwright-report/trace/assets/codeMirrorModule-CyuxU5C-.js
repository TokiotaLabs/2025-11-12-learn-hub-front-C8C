...
(function (Et, zt) {
  (function (C, De) {
    ...
    var C = navigator.userAgent,
      ...
      re = /Android/.test(C),
      ne =
        te || re || /webOS|BlackBerry|Opera Mini|Opera Mobi|IEMobile/i.test(C),
      se = te || /Mac/.test(De),
      Ae = /\bCrOS\b/.test(C),
      ye = /win/i.test(De),
...
`
    ...
    function qa(e, t, n) {
      ...
      for (
        var a = i.length, s = 0, u = 1, h = '', v, k, x = 0, M, E, R, U, Q;
        ;
        ...
        if (x == s) {
          ...
          if (ee)
            for (var st = 0; st < ee.length; st += 2)
              ee[st + 1] == x && (E += ' ' + ee[st]);
          if (!U || U.from == s)
            for (var Xe = 0; Xe < G.length; ++Xe) No(t, 0, G[Xe]);
          if (U && (U.from || 0) == s) {
            if (
              (No(
                t,
    ...
    function Zn(e, t, n, r, i) {
      return r || (r = ce(e.doc, t.line)), Yn(e, r, Ro(e, r, t.ch, i), n);
    }
      ...
      for (
        ...
        if (!a.hidden) {
          if (((i += a.line.height), b && N < 8)) {
            ...
            (u = k.bottom - k.top),
              !s &&
                a.text.firstChild &&
                (h =
                  a.text.firstChild.getBoundingClientRect().right - k.left - 1);
          }
          ...
          if (
            ...
            for (var M = 0; M < a.rest.length; M++) rl(a.rest[M]);
      ...
      for (var s = r.view, u = r.viewFrom, h = 0; h < s.length; h++) {
        ...
        if (!v.hidden)
          if (!v.node || v.node.parentNode != o) {
            ...
            v.changes &&
              (oe(v.changes, 'gutter') > -1 && (x = !1), Po(e, v, u, n)),
              x &&
                (D(v.lineNumber),
    ...
    function Nl(e, t) {
      if (!(t.text.length == 1 && t.text[0] == '' && Z(t.from, t.to) == 0)) {
        ...
        var r = [];
        vr(e, function (i, o) {
          !o && oe(r, i.history) == -1 && (zl(i.history, t), r.push(i.history)),
            Tn(i, t, null, ki(i, t));
        });
      }
    }
            ...
            var v = Ct(e, 'beforeChange') || (e.cm && Ct(e.cm, 'beforeChange')),
              k = function (E) {
                ...
                vr(e, function (G, ee) {
                  !ee &&
                    oe(Q, G.history) == -1 &&
                    (zl(G.history, R), Q.push(G.history)),
                    Tn(G, R, null, wl(G, R));
                });
              },
    ...
    function Ln(e, t, n, r) {
      var i = t,
        o = t;
      return (
        typeof t == 'number' ? (o = ce(e, ho(e, t))) : (i = f(t)),
    ...
    (kt.prototype = F(Dn.prototype, {
      ...
      setCursor: at(function (e, t, n) {
        Tl(this, Ce(this, typeof e == 'number' ? L(e, t || 0) : e), null, n);
      }),
...
`
                ...
                a = function () {
                  ++l == i &&
                    lt(t, function () {
                      ...
                      Jr(t.doc, x),
                        Ll(t.doc, pr(Ce(t.doc, n), Ce(t.doc, gr(x))));
                    })();
                },
                s = function (x, M) {
                  if (
    ...
    function Rs(e, t) {
      if (b && (!e.state.draggingText || +new Date() - Hl < 100)) {
        ar(t);
        return;
      }
      if (
    ...
    function Xs(e) {
      ...
      for (var n in e)
        if (e.hasOwnProperty(n)) {
          ...
          for (var i = Pe(n.split(' '), Gs), o = 0; o < i.length; o++) {
            var l = void 0,
              a = void 0;
            o == i.length - 1
              ? ((a = i.join(' ')), (l = r))
...
`,
    ...
    io.prototype.compare = function (e, t, n) {
      return this.time + eu > e && Z(t, this.pos) == 0 && n == this.button;
    };
    var Pn, In;
    function tu(e, t) {
      var n = +new Date();
            ...
            !(r && ru(t, i, r, o, e)) &&
              (i == 1
                ...
                : i == 2
                  ...
                  : i == 3 && (fe ? t.display.input.onContextMenu(e) : _i(t)));
        }
      }
    }
      ...
      function k(G) {
        if (Z(v, G) != 0)
          if (((v = G), r.unit == 'rectangle')) {
            ...
            (Qe[a] = au(e, new He(Ce(o, nt), rt))), pt(o, Kt(e, Qe, a), ct);
          }
      }
      ...
      function h(Q) {
        ...
        if (r == 'codepoint') {
          ...
          if (isNaN(ee)) G = null;
            ...
            var me =
              n > 0 ? ee >= 55296 && ee < 56320 : ee >= 56320 && ee < 57343;
            G = new L(
              t.line,
          ...
          for (var ee = G < 0 ? s.map : u[G], me = 0; me < ee.length; me += 3) {
            ...
            if (pe == R || pe == U) {
              var Fe = f(G < 0 ? e.line : e.rest[G]),
                Ke = ee[me] + Q;
              return (
                (Q < 0 || pe != R) && (Ke = ee[me + (Q ? 1 : 0)]), L(Fe, Ke)
              );
            }
          }
      }
