...
// filepath: /c:/Users/RaquelVillaverdePalm/Documents/learnHub/learn-hub-front/src/components/buttons/AuthButton.test.tsx
...
describe('AuthButton', () => {
  ...
  test('renders the button with outline variant', () => {
    render(
      <BrowserRouter>
        <AuthButton label="Sign Up" variant="outline" url="/signup" iconUrl=''/>
      </BrowserRouter>
    );
  ...
  test('renders the button with icon', () => {
    render(
      <BrowserRouter>
        <AuthButton label="Login" variant="solid" iconUrl="/icon.png" url="/login" />
      </BrowserRouter>
    );
