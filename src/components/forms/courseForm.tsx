...
const CourseForm: React.FC = () => {
  ...
  return (
    <div className="max-w-[768px] mx-auto w-full p-16 mt-6 mb-6 bg-white rounded-lg shadow-md">
        ...
        <p className='text-indigo-500 text-center font-medium text-lg'>El curso se ha creado correctamente.</p>
      </Modal>
      <h2 className="text-2xl text-indigo-500 font-bold mb-4">{isEditing ? 'Editar Curso' : 'Crear Nuevo Curso'}</h2>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button type="submit" className="w-full bg-indigo-500 text-white py-2 px-4 rounded-md cursor-pointer">
