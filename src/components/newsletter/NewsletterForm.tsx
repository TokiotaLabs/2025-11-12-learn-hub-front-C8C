...
export const NewsletterForm: React.FC = () => {
  return (
    ...
    >
      ...
      <button
        type="submit"
        className="overflow-hidden text-indigo-500 px-5 py-2.5 whitespace-nowrap bg-indigo-500 rounded-none border border-solid border-black border-opacity-0 rotate-[2.4492937051703357e-16rad]"
      >
        Subscribe
      </button>
    </form>
