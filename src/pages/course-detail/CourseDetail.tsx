        ...
        <div className="bg-[#636ae8] text-white py-16">
          <div className="max-w-6xl mx-auto px-8">
            ...
            <p className="text-xl mb-6">
              Learn JavaScript basics in this interactive course.
            </p>
            ...
            <div className="col-span-1">
              <div className="bg-white shadow-sm rounded-lg p-6 sticky top-6">
                <div className="mb-6">
                  ...
                  <button className="w-full bg-[#636ae8] text-[#636ae8] py-3 rounded-lg font-semibold mb-3">
                    Enroll Now
                  </button>
                  <button className="w-full border border-[#636ae8] text-[#636ae8] py-3 rounded-lg font-semibold">
                    Add to Wishlist
                  </button>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold">26 lessons</span>
                  </div>
                  <div className="flex justify-between">
