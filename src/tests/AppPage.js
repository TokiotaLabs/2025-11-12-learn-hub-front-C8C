...
class AppPage extends Page {
  ...
  editDetailsComment = async (comment) => {
    await this.page.inputText(
      await this.page.findElement(this.detailsInput),
      comment
    );
  };
  ...
  deactivateDetails = async () => {
    await this.page.click(
      await this.page.findElement(this.detailsDeactivateButton)
    );
  };
